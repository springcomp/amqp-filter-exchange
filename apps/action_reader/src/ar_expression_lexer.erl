...
-module(ar_expression_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/ar_expression_lexer.xrl", 40).
...
-file("src/ar_expression_lexer.erl", 331).
yystate() -> 23.
...
yystate(30, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(10, Ics, Line, Tlen+1, 10, Tlen);
yystate(30, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 84 ->
    yystate(10, Ics, Line, Tlen+1, 10, Tlen);
yystate(30, [C|Ics], Line, Tlen, _, _) when C >= 86, C =< 90 ->
    yystate(10, Ics, Line, Tlen+1, 10, Tlen);
...
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(10, Ics, Line, Tlen+1, 10, Tlen);
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 82 ->
    yystate(10, Ics, Line, Tlen+1, 10, Tlen);
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 84, C =< 90 ->
    yystate(10, Ics, Line, Tlen+1, 10, Tlen);
...
yystate(23, [84|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(23, [83|Ics], Line, Tlen, Action, Alen) ->
    yystate(2, Ics, Line, Tlen+1, Action, Alen);
yystate(23, [70|Ics], Line, Tlen, Action, Alen) ->
    yystate(21, Ics, Line, Tlen+1, Action, Alen);
...
yystate(23, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 69 ->
    yystate(10, Ics, Line, Tlen+1, Action, Alen);
yystate(23, [C|Ics], Line, Tlen, Action, Alen) when C >= 71, C =< 82 ->
    yystate(10, Ics, Line, Tlen+1, Action, Alen);
yystate(23, [C|Ics], Line, Tlen, Action, Alen) when C >= 85, C =< 90 ->
    yystate(10, Ics, Line, Tlen+1, Action, Alen);
yystate(23, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 101 ->
    yystate(10, Ics, Line, Tlen+1, Action, Alen);
yystate(23, [C|Ics], Line, Tlen, Action, Alen) when C >= 103, C =< 114 ->
    yystate(10, Ics, Line, Tlen+1, Action, Alen);
...
yystate(19, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
yystate(19, [C|Ics], Line, Tlen, Action, Alen) when C >= 35 ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
...
yystate(15, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
yystate(15, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 90 ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
...
-file("src/ar_expression_lexer.xrl", 21).
yyaction_0() ->
     skip_token .

-compile({inline,yyaction_1/2}).
-file("src/ar_expression_lexer.xrl", 22).
yyaction_1(TokenChars, TokenLine) ->
     t (t_eq, TokenLine, TokenChars) .

-compile({inline,yyaction_2/2}).
-file("src/ar_expression_lexer.xrl", 23).
yyaction_2(TokenChars, TokenLine) ->
     t (t_dot, TokenLine, TokenChars) .

-compile({inline,yyaction_3/2}).
-file("src/ar_expression_lexer.xrl", 24).
yyaction_3(TokenChars, TokenLine) ->
     t (t_semicolon, TokenLine, TokenChars) .

-compile({inline,yyaction_4/2}).
-file("src/ar_expression_lexer.xrl", 26).
yyaction_4(TokenChars, TokenLine) ->
     t (t_set, TokenLine, TokenChars) .

-compile({inline,yyaction_5/2}).
-file("src/ar_expression_lexer.xrl", 28).
yyaction_5(TokenChars, TokenLine) ->
     t (integer_constant, TokenLine, TokenChars) .

-compile({inline,yyaction_6/2}).
-file("src/ar_expression_lexer.xrl", 29).
yyaction_6(TokenChars, TokenLine) ->
     t (decimal_constant, TokenLine, TokenChars) .

-compile({inline,yyaction_7/2}).
-file("src/ar_expression_lexer.xrl", 30).
yyaction_7(TokenChars, TokenLine) ->
     t (approximate_number_constant, TokenLine, TokenChars) .

-compile({inline,yyaction_8/2}).
-file("src/ar_expression_lexer.xrl", 31).
yyaction_8(TokenChars, TokenLine) ->
     t (boolean_constant, TokenLine, TokenChars) .

-compile({inline,yyaction_9/2}).
-file("src/ar_expression_lexer.xrl", 32).
yyaction_9(TokenChars, TokenLine) ->
     t (string_constant, TokenLine, unquote_string_constant (TokenChars)) .

-compile({inline,yyaction_10/2}).
-file("src/ar_expression_lexer.xrl", 34).
yyaction_10(TokenChars, TokenLine) ->
     t (regular_identifier, TokenLine, TokenChars) .

-compile({inline,yyaction_11/2}).
-file("src/ar_expression_lexer.xrl", 35).
yyaction_11(TokenChars, TokenLine) ->
     t (quoted_identifier, TokenLine, unquote_quoted_identifier (TokenChars)) .

-compile({inline,yyaction_12/2}).
-file("src/ar_expression_lexer.xrl", 36).
yyaction_12(TokenChars, TokenLine) ->
     t (delimited_identifier, TokenLine, unquote_delimited_identifier (TokenChars)) .
